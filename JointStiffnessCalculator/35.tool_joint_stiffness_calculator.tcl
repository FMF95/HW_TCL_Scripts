...
# ##############################################################################
# Procedimiento para la seleccion del boton de estado
proc ::JointStiffnessCalculator::huthtypeSelector_1 { arg } { 

    variable huthtype_1
	
	switch $arg {
	    "Single_shear" { set huthtype_1 "Single_shear" }
		"Double_shear" { set huthtype_1 "Double_shear" }
	}
}
...
# ##############################################################################
# Procedimiento metodo crear PBUSH
...
# ##############################################################################
# Procedimiento metodo actualizar PBUSH
...
proc ::JointStiffnessCalculator::methodHuth { optShear optPlate optBolt D Young t1 E1 t2 E2 } {
    ...
    set KAxial [::JointStiffnessCalculator::huthAxial $Young $D $t1 $t2]
	set KShear [::JointStiffnessCalculator::huthShear $Young $D $E1 $t1 $E2 $t2 $n $a $b1 $b2]
...
############################################################################
proc ::JointStiffnessCalculator::huthAxial {Er dr t1 t2 } {
...
############################################################################
proc ::JointStiffnessCalculator::huthShear {Er dr E1i t1 E2i t2 n a b1 b2} {
    set procName [info level 0]
    set curNs [namespace current]
